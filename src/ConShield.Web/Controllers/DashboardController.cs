...
public sealed class DashboardController : Controller
{
    ...
    [
        ...
        new("Optional Live Trivy Scan", "Pre-deployment controls", "Manually run a bounded local Trivy scan when Trivy and image access are available; Web UI does not execute Trivy.", "dotnet run --project .\\src\\ConShield.Cli -- scan image `\n  --image alpine:3.19 `\n  --live-trivy `\n  --no-submit", "docs/CONTAINER_IMAGE_SCANNING.md", "SecurityEvents", "Index"),
        ...
        new("Optional Live Trivy Gate", "Pre-deployment controls", "Manually evaluate a live Trivy result against container policy; requires local Trivy and is not required for full validation.", "dotnet run --project .\\src\\ConShield.Cli -- gate image `\n  --image alpine:3.19 `\n  --live-trivy `\n  --fail-on block `\n  --no-submit", "docs/CICD_CONTAINER_GATE.md"),
        ...
        new("Optional Docker Live Watch", "Runtime and lifecycle", "Manually observe bounded live Docker container events when Docker Desktop is running.", "dotnet run --project .\\src\\ConShield.Cli -- lifecycle watch `\n  --duration-seconds 30 `\n  --no-submit", "docs/DOCKER_LIFECYCLE_COLLECTOR.md", "SecurityEvents", "Index"),
        ...
        new("Runtime Sensor Stream Collector", "Runtime and lifecycle", "Read a deterministic Falco-compatible JSON-lines stream, normalize events, and apply trust/signature handling without real Fedora/Falco.", "dotnet run --project .\\src\\ConShield.Cli -- sensor collect `\n  --from-json-lines .\\tests\\TestData\\Falco\\falco-runtime-stream.jsonl `\n  --demo-signature `\n  --no-submit", "docs/FALCO_RUNTIME_SENSOR.md", "RuntimeSensors", "Index"),
